...
/**
 * SYST17796 Final Project - UNO
 * @author Syed Ibraz Hassan Ghazi, Ethan Dao, Obada Agha
 * March 2022
 * @modifier Ethan Dao
 * @modifier Syed Ibraz Hassan Ghazi
 */

/**
 * The Card class to store the different values of the Uno cards. 
 * @author Hassan 
 */
public class Card {
